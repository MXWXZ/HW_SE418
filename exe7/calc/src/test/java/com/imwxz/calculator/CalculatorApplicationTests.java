...
public class CalculatorApplicationTests {
    ...
    private void performPost(String expression, String ans,
                             String username, String password,
                             int suc_code, String suc_ans) throws Exception {
    ...
    private void performPost(String expression, String ans,
                             int suc_code, String suc_ans) throws Exception {
        performPost(expression, ans, "admin", "123456", suc_code, suc_ans);
    }
    ...
    public void login() throws Exception {
        performPost("1", "0", "admin", "123456", 0, "1");
        performPost("1", "0", "admin", "wrong", 4, "");
    }
