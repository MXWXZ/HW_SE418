...
public class Calculator {
     ...
     * @throws CalcError
     */
    public String expression(String str, BigDecimal ans) throws CalcError {
        ...
        BigDecimal ret = digit.pop();
        return new BigDecimal(String.valueOf(ret.setScale(5, RoundingMode.HALF_UP))).stripTrailingZeros().toPlainString();
    }
